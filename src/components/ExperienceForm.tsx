...
export function ExperienceForm() {
  ...
  return (
    <div className="bg-white p-14 border border-[#f0f0f0] w-full max-w-[860px]">
      {/* Card Header */}
      <div className="flex items-start justify-between mb-16">
        <div>
          ...
          <span className="text-[12px] font-bold text-[#1a1a1a] opacity-60 uppercase tracking-wider block mt-1.5">
            2021 — PRESENT [ACTIVE]
          </span>
        </div>
      ...
      <div className="mt-16">
        <div className="flex items-center justify-between mb-4 px-1">
            <span className="text-[12px] font-bold uppercase tracking-wider text-[#1a1a1a] opacity-60">
                Responsibilities Entries
            </span>
            <span className="text-[12px] font-bold text-[#1a1a1a] opacity-30">
