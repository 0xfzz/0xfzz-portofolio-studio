  ...
  return (
    <div className="space-y-10 pb-32">
      ...
      <div className="fixed bottom-12 right-12 flex items-center gap-4 z-50">
        ...
        {status === 'error' && (
          <div className="bg-red-500 text-white px-6 py-3 shadow-lg rounded-[2px] text-[11px] font-mono font-bold uppercase tracking-[0.2em] animate-in fade-in slide-in-from-bottom-2">
            SAVE FAILED
          </div>
        )}
        <button
